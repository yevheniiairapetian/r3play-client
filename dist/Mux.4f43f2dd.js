...
})({"b1mlp":[function(require,module,exports) {
...
module.bundle.HMR_BUNDLE_ID = "990c0cb74f43f2dd";
"use strict";
...
},{"6d18d6bd340e7473":"786KC","74ad5ea14201648c":"1dldy"}],"ekS5Z":[function(require,module,exports) {
...
var import_react = __toESM(require("d306dc2949e7c5dc"));
var import_patterns = require("abe17614cedbfcc2");
...
class Mux extends import_react.Component {
    ...
    async load(url) {
        ...
        if (!((_a = globalThis.customElements) == null ? void 0 : _a.get("mux-player"))) try {
            ...
            await require(/* webpackIgnore: true */ `${sdkUrl}`);
            this.props.onLoaded();
        } catch (error) {
            onError(error);
        }
...
},{"d306dc2949e7c5dc":"21dqq","abe17614cedbfcc2":"eeZWi"}]},["b1mlp","1xC6H"], null, "parcelRequire245c")

//# sourceMappingURL=Mux.4f43f2dd.js.map
