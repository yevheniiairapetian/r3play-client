    ...
    return (
      ...
      <Carousel.Item>
        <Image className="w-100" src={"https://wallpapercave.com/wp/UjqdzkB.jpg"} text="An image showing Ergo Proxy cyberpunk anime poster" /> 
          <Carousel.Caption>
            <h3 className="bg-dark pt-3 pb-3 bg-carousel carousel-caption-header">Like cyberpunk anime? Don't miss out on Ergo Proxy</h3>
            <Link to={`/animes/651617b581bacee8dbbc820d`}>
            <Button className='carousel-button bg-success text-light p4-5 pr-4' variant='outline-dark'>More</Button>
          </Link>
